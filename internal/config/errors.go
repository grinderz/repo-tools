...
var (
	...
	errNotDepsKind      = errors.New("is not a deps_cmds kind")
	...
	errNoDepsKinds      = errors.New("but deps_cmds defines no kinds")
	errNotInDepsCmds    = errors.New("is not in deps_cmds")
	errNoChangelogCmds  = errors.New("changelog is enabled but no changelog_cmds are set")
